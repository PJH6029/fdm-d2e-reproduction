...
Latest known live run snapshot: 2026-05-21 15:04 KST.
...
- Pod checkout was synced to commit `bf16ac4` (`Make G004 FDM features causal`); G003/G004/G005/G006/G007/G008/G009 completion audit scripts are present in pod.
- Latest monitor artifact: `artifacts/idm/g003_full_compact_parallel_progress.json`.
- Last decoded count: `92 / 918` recording variants; shard summaries `0 / 16`; IDM metrics absent.
