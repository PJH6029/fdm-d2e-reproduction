...
Latest known live run snapshot: 2026-05-21 14:08 KST.
...
- Pod checkout was synced to commit `02d4b14` (`Add G005 aux completion audit`); G003/G004/G005 completion audit scripts are present in pod.
- Latest monitor artifact: `artifacts/idm/g003_full_compact_parallel_progress.json`.
- Last decoded count: `78 / 918` recording variants; shard summaries `0 / 16`; IDM metrics absent.
