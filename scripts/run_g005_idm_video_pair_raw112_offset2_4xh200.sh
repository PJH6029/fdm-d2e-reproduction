...
export LOG_PATH="${LOG_PATH:-artifacts/idm/g005_idm_video_pair_raw112_offset2_keysoftmax_4xh200.log}"
export RUN_SUMMARY="${RUN_SUMMARY:-artifacts/idm/g005_idm_video_pair_raw112_offset2_keysoftmax_4xh200_run.json}"
export GPU_MONITOR_LOG="${GPU_MONITOR_LOG:-artifacts/idm/g005_idm_video_pair_raw112_offset2_keysoftmax_4xh200_gpu_monitor.csv}"
export PID_FILE="${PID_FILE:-outputs/cluster/g005_idm_video_pair_raw112_offset2_keysoftmax_4xh200.pid}"
export GPU_SMOKE_REPORT="${GPU_SMOKE_REPORT:-outputs/cluster/g005_idm_video_pair_raw112_offset2_keysoftmax_gpu_smoke.json}"
...
exec scripts/run_g005_idm_video_pair_raw112_4xh200.sh
