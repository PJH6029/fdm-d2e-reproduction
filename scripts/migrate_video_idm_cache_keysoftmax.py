...
def migrate_cache(source_config: dict[str, Any], target_config: dict[str, Any], *, force: bool = False) -> dict[str, Any]:
    torch = require_torch()
...
def main() -> int:
    ...
    summary = migrate_cache(load_config(args.source_config), load_config(args.target_config), force=args.force)
