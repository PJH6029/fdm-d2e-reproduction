...
DEFAULT_PATTERNS = [
    ...
    "scripts/build_g005_aux_action_registry.py",
    "scripts/build_g005_aux_namespace_manifest.py",
    "scripts/build_g005_aux_source_evidence.py",
    "scripts/build_g005_aux_archive_inventory.py",
    "scripts/materialize_g005_aux_sources.py",
    "scripts/monitor_g005_aux_materialization.py",
    "scripts/validate_g005_aux_materialization_integrity.py",
    "scripts/build_g005_eval_manifest_hashes.py",
    "scripts/plan_g005_launch.py",
    "scripts/finalize_g005_aux_best_model.py",
    "scripts/watch_g005_then_finalize.py",
    "scripts/watch_g005_aux_materialization.py",
    "scripts/watch_g004_then_plan_g005.py",
    ...
    "scripts/watch_g003_then_launch_g004.py",
    ...
    "tests/test_g005_aux_action_registry.py",
    "tests/test_g005_aux_source_evidence_builder.py",
    "tests/test_g005_aux_archive_inventory.py",
    "tests/test_g005_aux_materializer.py",
    "tests/test_g005_aux_materialization_monitor.py",
    "tests/test_g005_aux_materialization_integrity.py",
    "tests/test_g005_namespace_manifest_builder.py",
    "tests/test_g005_finalization.py",
    "tests/test_g005_aux_materialization_watcher.py",
    "tests/test_g004_to_g005_readiness_chain.py",
    ...
    "tests/test_g003_to_g004_chain_watcher.py",
    ...
    "tests/test_g005_eval_manifest_hash_builder.py",
    ...
    "artifacts/fdm/g003_to_g004_chain_summary*.json",
    ...
    "artifacts/aux/*.json",
    "artifacts/aux/g005_aux_action_registry.json",
    "artifacts/aux/g005_aux_materialization_progress.json",
    "artifacts/aux/g005_aux_materialization_integrity.json",
    "artifacts/aux/g005_aux_archive_inventory.json",
    "artifacts/aux/d2e_eval_manifest_hashes.json",
    "artifacts/aux/g005_aux_source_materialization_evidence.json",
    "artifacts/aux/g005_launch_readiness*.json",
    "artifacts/aux/g004_to_g005_readiness_chain_summary*.json",
