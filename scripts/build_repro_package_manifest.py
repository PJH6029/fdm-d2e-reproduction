...
DEFAULT_PATTERNS = [
    ...
    "scripts/build_g005_aux_loader_manifest.py",
    ...
    "scripts/run_g003_accel64_training_resume.sh",
    ...
    "scripts/promote_g003_accel64_to_canonical.py",
    ...
    "scripts/build_external_artifact_manifest.py",
    ...
    "src/fdm_d2e/process_liveness.py",
    ...
    "tests/test_g005_aux_runtime_env.py",
    ...
    "tests/test_g003_accel64_promotion.py",
    ...
    "outputs/fdm_streaming_d2e_full_compact/torch_model/*",
    ...
    "artifacts/fdm/g004_d2e_full_fdm_4xh200_gpu_monitor*",
    ...
    "artifacts/aux/g005_aux_loader_manifest.json",
    "artifacts/aux/g005_aux_examples_summary.json",
    "artifacts/aux/g005_aux_runtime_env.json",
    ...
    "outputs/fdm_aux/d2e_aux_best/checkpoint.pt",
    "outputs/fdm_aux/d2e_aux_best/checkpoint_metadata.json",
    "outputs/fdm_aux/d2e_aux_best/resolved_config.json",
    "outputs/fdm_aux/d2e_aux_best/metrics.json",
    "outputs/fdm_aux/d2e_aux_best/prediction_build_summary.json",
    "outputs/fdm_aux/d2e_aux_best/statistical_comparison.json",
    "outputs/fdm_aux/d2e_aux_best/split_*_statistical_comparison.json",
    ...
    "artifacts/eval/g00[345]_split_statistical_comparisons_summary.json",
    ...
    "artifacts/harness/g008_repo_live_suite/**/*",
