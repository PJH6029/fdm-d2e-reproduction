...
MODEL_SLUG="${MODEL_SLUG:-g005_idm_temporal_masked_diffusion_raw96_patch_axisclass_realvideo_train320k_offsetensemble_fast1k}"
...
CONFIG="${CONFIG:-configs/model/idm_temporal_masked_diffusion_d2e_raw96_patch_axisclass_realvideo_train320k_offsetensemble_fast1k.yaml}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/idm_temporal_masked_diffusion_d2e_raw96_patch_axisclass_realvideo_train320k_offsetensemble_fast1k}"
...
WANDB_TAGS="${WANDB_TAGS:-g005,idm,d2e,fdm1-recipe,raw96,train320k,offset-ensemble,fast1k,prediction-only}"
...
compact={
  'schema':'g005_temporal_offsetensemble_fast1k_compact.v1',
