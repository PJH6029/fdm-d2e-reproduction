...
CONFIG="${CONFIG:-configs/model/idm_streaming_d2e_full_event_state_context_paper_target.yaml}"
MODEL_SLUG="${MODEL_SLUG:-g005_idm_event_state_context}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/idm_streaming_d2e_full_event_state_context_paper_target}"
INPUT_ROOT="${INPUT_ROOT:-outputs/data/d2e_full_corpus_shards_accel64}"
CONTEXT_OUTPUT_ROOT="${CONTEXT_OUTPUT_ROOT:-outputs/data/d2e_event_state_context_shards_accel64}"
...
RUN_SUMMARY="${RUN_SUMMARY:-artifacts/idm/g005_idm_event_state_context_4xh200_run.json}"
GPU_MONITOR_LOG="${GPU_MONITOR_LOG:-artifacts/idm/g005_idm_event_state_context_4xh200_gpu_monitor.csv}"
PID_FILE="${PID_FILE:-outputs/cluster/g005_idm_event_state_context_4xh200.pid}"
GPU_SMOKE_REPORT="${GPU_SMOKE_REPORT:-outputs/cluster/g005_idm_event_state_context_gpu_smoke.json}"
WANDB_SIDECAR_STATUS="${WANDB_SIDECAR_STATUS:-artifacts/idm/g005_idm_event_state_context_wandb_sidecar_status.json}"
WANDB_SIDECAR_LOG="${WANDB_SIDECAR_LOG:-artifacts/idm/g005_idm_event_state_context_wandb_sidecar.log}"
